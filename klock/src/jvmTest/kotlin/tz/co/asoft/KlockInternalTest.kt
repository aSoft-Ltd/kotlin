...
import tz.co.asoft.internal.KlockInternalJvm
import tz.co.asoft.internal.TemporalKlockInternalJvm
...
class KlockInternalTest {
    ...
    fun testThatNowLocalHasTimezoneIntoAccount() {
        TemporalKlockInternalJvm(object :
            KlockInternalJvm {
            ...
            assertEquals("Mon, 24 Jun 2019 19:15:54 UTC", DateTime.now()
                .toString())
            assertEquals("Mon, 24 Jun 2019 21:15:54 GMT+0200", DateTime.nowLocal()
                .toString())
        }
    }
	...
	fun testBug38() {
        ...
        TemporalKlockInternalJvm(object :
            ...
            assertEquals("Mon, 15 Apr 2019 11:14:30 UTC", DateTime.now()
                .toString())
            assertEquals("Mon, 15 Apr 2019 20:14:30 GMT+0900", DateTime.nowLocal()
                .toString())
            assertEquals("1555326870000", DateTime.nowUnixLong()
                .toString())
            assertEquals("Mon, 15 Apr 2019 20:14:30 GMT+0900", DateTimeTz.nowLocal()
                .toString())
