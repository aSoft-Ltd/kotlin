...
import tz.co.asoft.internal.ext8
...
class AES(val keyWords: IntArray) {
	...
	fun encryptBlock(M: IntArray, offset: Int) {
		this.doCryptBlock(M, offset, this.keySchedule,
            SUB_MIX_0,
            SUB_MIX_1,
            SUB_MIX_2,
            SUB_MIX_3,
	...
	companion object {
        ...
        @Deprecated("This was a typo", ReplaceWith("encryptAes128Cbc(data, key)", "tz.co.asoft.krypto.AES.Companion.encryptAes128Cbc"))
        fun encryptEes128Cbc(data: ByteArray, key: ByteArray): ByteArray =
            encryptAes128Cbc(data, key)
