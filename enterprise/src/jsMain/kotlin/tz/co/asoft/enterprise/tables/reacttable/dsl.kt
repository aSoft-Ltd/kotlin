...
import tz.co.asoft.enterprise.tables.TAction.*
import tz.co.asoft.enterprise.tables.TAction.LinkOutlinedButton
        ...
        styledDiv {
            ...
            for (action in actions) {
                when (action) {
                    ...
                    is LinkContainedButton -> LinkContainedButton(
                        name = action.name,
                        to = action.to,
                        icon = action.icon
                    )
                    is LinkOutlinedButton -> LinkOutlinedButton(
                        name = action.name,
                        to = action.to,
                        icon = action.icon
                    )
                    is LinkTextButton -> LinkTextButton(
                        name = action.name,
                        to = action.to,
                        icon = action.icon
                    )
