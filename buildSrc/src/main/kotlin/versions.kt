object versions {
    ...
    object kotlinjs {
        const val react = "16.13.1-pre.105-kotlin-1.3.72"
        const val reactDom = react
        const val reactRouterDom = "5.1.2-pre.105-kotlin-1.3.72"
        const val styled = "1.0.0-pre.105-kotlin-1.3.72"
        const val css = "1.0.0-pre.105-kotlin-1.3.72"
        const val extensions = "1.0.1-pre.105-kotlin-1.3.72"
    }

    object firebase {
        const val core = "17.2.1"
        const val firestore = "21.3.0"
        const val auth = "19.1.0"
        const val storage = "19.1.0"
        const val admin = "6.9.0"
    }
}