...
import tz.co.asoft.firebase.firestore.QueryParam.Operator
...
infix fun String.isLessThan(other: String) =
    QueryParam(this, Operator.LessThan, other)
...
infix fun String.equals(other: String) =
    QueryParam(this, Operator.Equals, other)
...
infix fun String.isGreaterThan(other: String) =
    QueryParam(this, Operator.GreaterThan, other)
